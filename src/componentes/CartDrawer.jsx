...
const CartDrawer = ({ isOpen, onClose }) => {
  ...
  // useEffect para calcular el costo de envío cada vez que cambie el total del carrito
  useEffect(() => {
    const calculateShipping = () => {
      if (cartTotal >= 50000) {
        return 0; // Envío gratis si el total es superior a 50,000 ARS
      } else {
        return cartTotal * 0.25; // 25% del total
      }
    };
